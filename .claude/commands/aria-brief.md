...
3. EXECUTE the matching workflow:
   ...
   **Brief mode (default):**
   - LOAD workflow config: {project-root}/_aria/linear/workflows/1-analysis/create-product-brief/workflow-linear.yaml
   - READ and FOLLOW: {project-root}/_aria/linear/workflows/1-analysis/create-product-brief/instructions-linear.md
   ...
   **Context mode:**
   - LOAD workflow config: {project-root}/_aria/linear/workflows/1-analysis/generate-project-context/workflow-linear.yaml
   - READ and FOLLOW: {project-root}/_aria/linear/workflows/1-analysis/generate-project-context/instructions-linear.md
