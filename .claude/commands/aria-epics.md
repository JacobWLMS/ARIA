...
2. LOAD the workflow config: {project-root}/_aria/linear/workflows/3-solutioning/create-epics-and-stories/workflow-linear.yaml
3. READ and FOLLOW the workflow instructions, including the Linear output step: {project-root}/_aria/linear/workflows/3-solutioning/create-epics-and-stories/steps/step-04-linear-output.md
4. Use the template: {project-root}/_aria/shared/templates/epics-template.md
5. Load the PRD from Linear Documents via the read-linear-context task
6. Create Epics as Linear Projects and Stories as Linear Issues per the artefact-mapping.yaml
7. Store created IDs in .linear-key-map.yaml
