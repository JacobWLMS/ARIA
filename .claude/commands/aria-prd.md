...
2. DETECT the mode from $ARGUMENTS or auto-detect from Linear state:
   ...
   **Auto-detection:**
   - Check if a PRD document exists via list_documents with query "[{team_name}] PRD"
...
3. EXECUTE the matching workflow:
   ...
   **Create mode:**
   - LOAD workflow config: {project-root}/_aria/core/workflows/2-plan-workflows/create-prd/workflow.yaml
   ...
   **Edit mode:**
   - LOAD workflow config: {project-root}/_aria/core/workflows/2-plan-workflows/edit-prd/workflow.yaml
   - READ and FOLLOW: {project-root}/_aria/core/workflows/2-plan-workflows/edit-prd/instructions.md
   - Load existing PRD from Linear Documents
   - Apply feedback and update the document

   **Validate mode:**
   - LOAD workflow config: {project-root}/_aria/core/workflows/2-plan-workflows/validate-prd/workflow.yaml
   - READ and FOLLOW: {project-root}/_aria/core/workflows/2-plan-workflows/validate-prd/instructions.md
   - Use checklist: {project-root}/_aria/shared/checklists/prd-checklist.md
