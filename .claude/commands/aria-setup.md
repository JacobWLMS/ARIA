---
description: 'Discover platform team, statuses, and configure labels for your workspace'
---
...
5. Create any missing ARIA labels
6. Resolve users for default assignee
7. Populate module.yaml with discovered values
8. Initialize .key-map.yaml from template
</steps>
