...
Detailed reference documentation for ARIA's configuration, tools, and resources.

- **[Slash Commands](slash-commands.md)** -- all 27 commands organized by phase
- **[Configuration](configuration.md)** -- module.yaml variable reference
