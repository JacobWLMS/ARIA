...
Design and get user approval for the epic structure that will organise all requirements into user-value-focused epics. Epics in the platform are represented as Projects.
