...
**Purpose:** Given the compact state summary from the Linear State Reader, determine which ARIA agent to delegate to next via Claude Code's Agent tool. The orchestrator NEVER executes agent work directly.
...
1. **You are the dispatcher.** You NEVER write to Linear directly. You never call `save_issue`, `save_comment`, `save_project`, `create_document`, or any write MCP tool.
...
Read module.yaml config from {project-root}/_aria/linear/module.yaml.
...
Follow ALL critical actions from the agent YAML and base-critical-actions.yaml at {project-root}/_aria/linear/agents/base-critical-actions.yaml.
...
<agent_yaml>{project-root}/_aria/linear/agents/{target_agent}.agent.yaml</agent_yaml>
...
<procedure>
  ...
  2. Look up the target agent's YAML path: {project-root}/_aria/linear/agents/{target_agent}.agent.yaml
...
<agent_yaml>{project-root}/_aria/linear/agents/analyst.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/1-analysis/create-product-brief/workflow-linear.yaml</workflow_yaml>
...
<agent_yaml>{project-root}/_aria/linear/agents/pm.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/2-plan-workflows/create-prd/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent_yaml>{project-root}/_aria/linear/agents/ux-designer.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/2-plan-workflows/create-ux-design/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent>PM (Maestro)</agent>
<agent_yaml>{project-root}/_aria/linear/agents/pm.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/3-solutioning/create-epics-and-stories/workflow-linear.yaml</workflow_yaml>
<context_to_load>
  - PRD doc ID from key map
...
<agent_yaml>{project-root}/_aria/linear/agents/architect.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/3-solutioning/create-architecture/workflow-linear.yaml</workflow_yaml>
<context_to_load>
  - PRD doc ID from key map
  - UX Design doc ID from key map (if exists)
...
<agent_yaml>{project-root}/_aria/linear/agents/security.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/3-solutioning/threat-model/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent>Architect (Opus)</agent>
<agent_yaml>{project-root}/_aria/linear/agents/architect.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/3-solutioning/check-implementation-readiness/workflow-linear.yaml</workflow_yaml>
<context_to_load>
  - PRD doc ID from key map
  - Architecture doc ID from key map
  - UX Design doc ID from key map (if exists)
...
<agent_yaml>{project-root}/_aria/linear/agents/sm.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/4-implementation/sprint-planning/workflow-linear.yaml</workflow_yaml>
<context_to_load>
  - Project IDs from key map
...
<agent>SM (Tempo)</agent>
<agent_yaml>{project-root}/_aria/linear/agents/sm.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/4-implementation/create-story/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent_yaml>{project-root}/_aria/linear/agents/dev.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/4-implementation/dev-story/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent_yaml>{project-root}/_aria/linear/agents/qa.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/4-implementation/code-review/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent>SM (Tempo)</agent>
<agent_yaml>{project-root}/_aria/linear/agents/sm.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/4-implementation/retrospective/workflow-linear.yaml</workflow_yaml>
<context_to_load>
...
<agent_yaml>{project-root}/_aria/linear/agents/devops.agent.yaml</agent_yaml>
<workflow_yaml>{project-root}/_aria/linear/workflows/5-release/release-plan/workflow-linear.yaml</workflow_yaml>
<context_to_load>
  - Architecture doc ID from key map
  - Project ID from key map
  - Done issue identifiers from state summary
...
```
1. Run linear-state-reader to get compact state summary (3-5 API calls)
...
- **Cooldown:** 5-second pause between dispatches (prevents Linear API rate limiting)
