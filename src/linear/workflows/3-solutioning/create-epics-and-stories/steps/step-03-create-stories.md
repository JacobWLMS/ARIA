...
<action>Ask: "The complete epic and story structure is ready. Review the summary above. [C] Continue to Linear output, or discuss changes?"</action>
</step>

<step n="3.7" goal="Confirm and proceed to Linear output">
<action>Display: "**All epics and stories are approved. Select an option:** [C] Continue to write to Linear"</action>

**Menu handling:**
- IF **C**: Proceed to step-04-linear-output.md — carry the complete epics/stories structure forward in working memory for Linear creation
...
- Complete structure approved and ready for Linear output
